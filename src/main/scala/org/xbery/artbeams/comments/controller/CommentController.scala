...
class CommentController @Inject()(commentRepository: CommentRepository, commentService: CommentService, common: ControllerComponents) extends BaseController(common) {
