...
<form action="/admin/categories/save" method="post" class="form-horizontal">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10"><input type="text" name="${fields.slug.name}" value="${fields.slug.value!}" id="${fields.slug.elementId}" size="30"/></div>
  </div>
  <div class="form-group row">
    <label for="${fields.title.elementId}" class="col-sm-2 col-form-label">Title</label>
    <div class="col-sm-10"><input type="text" name="${fields.title.name}" value="${fields.title.value!}" id="${fields.title.elementId}" size="100"/></div>
  </div>
  <div class="form-group row">
    <label for="${fields.description.elementId}" class="col-sm-2 col-form-label">Description</label>
    <div class="col-sm-10"><textarea name="${fields.description.name}" id="${fields.description.elementId}" rows="2" cols="160">${fields.description.value!}</textarea></div>
  </div>
  <div class="form-group row">
    <label for="${fields.validFrom.elementId}" class="col-sm-2 col-form-label">Valid from</label>
    <div class="col-sm-10"><input type="text" name="${fields.validFrom.name}" value="${fields.validFrom.value}" id="${fields.validFrom.elementId}" /></div>
  </div>
  <div class="form-group row">
    <label for="${fields.validTo.elementId}" class="col-sm-2 col-form-label">Valid to</label>
    <div class="col-sm-10"><input type="text" name="${fields.validTo.name}" value="${fields.validTo.value!}" id="${fields.validTo.elementId}" /></div>
  </div>
  <div class="form-group row">
