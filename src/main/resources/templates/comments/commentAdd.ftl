...
<div class="comment-add" id="comment-add">
    ...
    <form action="/comments" method="post">
      ...
      <div class="form-group row">
        <label for="${fields.antispamAnswer.elementId}" class="col-form-label col-sm-6 label-fix cursor-help" title="Kontrolní otázka - ochrana proti robotům">${fields.antispamQuestion.value!} *</label>
        <div class="col-sm-6">
