...
class ArticleImageRepository(
     ...
     */
    open fun storeArticleImage(inputStream: InputStream, originalFileName: String): String? = mediaRepository.storeImageResponsiveVariants(
        inputStream,
        originalFileName,
        ImageFormat.WEBP.name,
        false
    )
    ...
    private fun storeArticleImageWithWidth(
        ...
        .createTempFilePath("article-image-", "-$targetWidth-$fileName")
