...
/**
 * Generator for JSON-LD structured data for SEO/GEO optimization. Supports Schema.org vocabularies
 * for articles, authors, breadcrumbs, and website metadata.
 *
 * @author Radek Beran
 */
        ...
        return """
{
  ...
  "inLanguage": "cs-CZ"
    ...
    /**
     * Generates JSON-LD breadcrumb structured data. Helps search engines and LLMs understand site
     * hierarchy.
     *
...
$itemListElements
    ...
    /**
     * Generates JSON-LD for the website entity. Should be included on the homepage and optionally on
     * other pages.
     *
     * @param siteName Name of the website
        ...
        return """
{
  ...
  "description": "${escapeJson(description)}"$searchAction
    ...
    /**
     * Generates JSON-LD for an organization. Useful for about pages and footer information.
     *
        ...
        return """
{
  ...
  "description": "${escapeJson(description)}"$foundingDateField
    ...
    /**
     * Generates JSON-LD for a person (author profile). Enhances author credibility for GEO.
     *
     ...
     * @param socialLinks Optional map of social media platform to URL (e.g., "Twitter" to
     * "https://twitter.com/...")
        ...
        return """
{
  ...
  "url": "$authorUrl"$bioField$worksForField$sameAsField
    ...
    /**
     * Generates JSON-LD for FAQ structured data. Useful for articles that contain question-answer
     * pairs.
     *
...
$faqItems
    ...
    private fun countWords(html: String): Int = html
