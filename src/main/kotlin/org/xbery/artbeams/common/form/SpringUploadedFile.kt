...
class SpringUploadedFile(
    ...
    override fun getContent(): ReadableByteChannel = Channels.newChannel(multipartFile.inputStream)
    ...
    override fun toString(): String = "File $fileName, size=$size, type=$contentType"
