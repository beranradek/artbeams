...
open class CourseModulesRecord() : UpdatableRecordImpl<CourseModulesRecord>(CourseModules.COURSE_MODULES) {
    ...
    /**
     * Create a detached, initialised CourseModulesRecord
     */
    constructor(id: String? = null, courseId: String? = null, title: String? = null, image: String? = null, shortDescription: String? = null, perex: String? = null, sortOrder: Int? = null): this() {
        this.id = id
