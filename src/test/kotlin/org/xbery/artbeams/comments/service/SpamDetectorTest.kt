...
class SpamDetectorTest :
    StringSpec({
        ...
        "should detect the specific spam example from the user query" {
            val spamComment =
                "https://canvas.instructure.com/eportfolios/3678306/home/el-mejor-sustrato-para-tu-kit-de-cultivo-indoor " +
                    "Cuando decidi empezar mi cultivo en casa, lo primero que pense fue: como elijo el mejor " +
                    "Kit de Cultivo Indoor? Vivo en Chile, y aunque hay varias opciones, no tenia idea de por donde " +
                    "empezar. Entre tantas tiendas online, marcas y tipos de kits, me senti abrumado. Lo que me salvo " +
                    "fue encontrar un blog que explicaba como elegir tu primer Kit de Cultivo Indoor segun tu espacio, " +
                    "tipo de planta y presupuesto. Tambien hablaban de los errores mas comunes (como comprar un kit " +
                    "sin buena ventilacion o con luces inadecuadas) y donde comprar en Chile sin caer en estafas o " +
                    "kits de baja calidad. Aprendi que no se trata solo de tener una carpa, sino de un sistema " +
                    "completo: iluminacion LED eficiente, extractor, timer, sustrato, fertilizantes, y hasta el tipo " +
                    "de macetas influye en el resultado. Gracias a esa info, mi primer cultivo fue un exito. Ahora " +
                    "tengo un espacio funcional, limpio y con plantas sanas. Si estas empezando, de verdad te " +
                    "recomiendo leer antes de comprar. Ahi entendi todo lo que necesitaba."
